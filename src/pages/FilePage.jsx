  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-12 pr-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-slate-300 focus:border-transparent outline-none bg-white shadow-sm"
            />
      ...
      <main className="max-w-7xl mx-auto px-6 pb-12">
        {/* Breadcrumb */}
        <Breadcrumb currentFolderName={folderName} onBack={() => window.history.back()} />
        ...
        {files.length === 0 ? (
          <div className="text-center py-16 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-300">
            ...
            <h3 className="text-xl font-medium text-gray-700 mb-2">Aucun fichier</h3>
            <p className="text-gray-500 mb-6">Glissez des fichiers ici ou cliquez ci-dessus pour en ajouter</p>
          </div>
        ) : (
